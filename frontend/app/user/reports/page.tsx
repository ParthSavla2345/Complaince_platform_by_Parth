      ...
      if (response.ok) {
        setReportData({
          ...
          categoryScores: Object.fromEntries(
            Object.entries(data.categoryScores || {}).map(([key, value]) => [key, Math.min(Number(value), 100)])
          ),
          attempts: data.attempts.map(attempt => ({
            ...attempt,
            overallPercentage: Math.min(attempt.overallPercentage, 100)
          })),
                    ...
                    <Card className="bg-white/10 backdrop-blur-md border-white/20">
                      ...
                      <CardContent>
                        ...
                        <div className="text-gray-300">
                          ...
                          <p>
                            <strong>Impact:</strong> This category accounts for a significant portion of your overall security posture.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
